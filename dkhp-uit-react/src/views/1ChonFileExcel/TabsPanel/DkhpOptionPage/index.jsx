    ...
    <FormControl component="fieldset" className={classes.root}>
      ...
      <li>
        ...
        <Tooltip title={'Bấm đi'}>
          <CopyToClipboard
            text={getDataDkhpScript}
            onCopy={() => enqueueSnackbar('Đã copy script vào clipboard')}
          >
      ...
      <li>
        ...
        <Tooltip title={'Tới luôn'}>
          <Link
            href="https://dkhp.uit.edu.vn/sinhvien/hocphan/dangky"
            target="_blank"
        ...
        <i>
          {' '}
          Nếu trên cửa sổ console xuất ra <b>"Copy to clipboard successfully, good luck"</b> có
          nghĩa là đã lấy dữ liệu thành công, còn nếu không có dòng chữ các bạn có thể liên hệ{' '}
          <Tooltip title="Nhờ Lợi giúp">
            <Link
              href="https://www.messenger.com/t/loia5tqd001"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <li>
        ...
        <Link
          href="https://dkhp.uit.edu.vn/sinhvien/hocphan/dangky-anhvan"
          target="_blank"
          rel="noopener noreferrer"
        >
